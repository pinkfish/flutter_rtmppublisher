  ...
  Widget build(BuildContext context) {
    return (controller.value.isInitialized ?? false)
        ? controller.value.previewSize!.width <
            ...
            ? RotatedBox(
                quarterTurns: (controller.value.previewQuarterTurns ?? 0),
